				...
				<div className="mx-auto max-w-2xl space-y-6">
					...
					<div className="space-y-3">
						...
						<p className="text-lg text-muted-foreground">
							Your central hub for water treatment projects. Reduce proposal
							preparation time from weeks to minutes.
						</p>
					</div>
					...
					<div className="pt-6 border-t border-border/40">
						<p className="text-sm text-muted-foreground">
							💡 <strong>Tip:</strong> Start by creating your first project. You
							only need 4 basic pieces of data to generate a conceptual
							proposal.
						</p>
					</div>
				</div>
