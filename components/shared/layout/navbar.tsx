              ...
              <DropdownMenu>
                <DropdownMenuTrigger asChild>
                  <button
                    ...
                    className={cn(buttonVariants({ variant: "ghost", size: "icon" }), "relative h-9 w-9 rounded-full p-0 bg-white/5 text-foreground hover:bg-white/10 transition-all duration-300")}
                  >
              ...
              <SheetContent side="left" className="glass-card pr-0">
                <SheetHeader>
                  <SheetTitle className="flex items-center">
                    ...
                    <span className="ml-2 font-serif text-lg text-gradient">H2O Allegiant</span>
                  </SheetTitle>
                  <SheetDescription>
