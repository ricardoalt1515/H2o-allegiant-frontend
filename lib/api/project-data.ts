...
export class ProjectDataAPI {
  ...
  static async getData(projectId: string): Promise<ProjectData> {
    const response = await apiClient.get<ProjectDataResponse>(`/projects/${projectId}/data`)
  ...
  static async addQualityParameter(
    ...
    return this.updateData(projectId, updates, true)
  }
  ...
  static async deleteQualityParameter(
    ...
    // Get current data
    const currentData = await this.getData(projectId)
    ...
    await this.updateData(projectId, currentData, false)
  }
  ...
  static async deleteSection(
    ...
    if (currentData.sections) {
      ...
      // Update
      await this.updateData(projectId, { sections }, true)
    }
  }
