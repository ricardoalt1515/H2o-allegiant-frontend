...
export const PARAMETER_LIBRARY: ParameterDefinition[] = [
  ...
  },
  {
    ...
    type: "number",
    defaultValue: "",
    description: "Ratio between peak and average flow (e.g., 1.8 means peak is 1.8x average). Corresponds to Q9: average water volumes and peak consumption rates",
    tags: ["peak", "factor", "variation", "flow"],
    suggestedSource: "manual",
    typicalRange: { min: 1.0, max: 4.0 },
    validationRule: (value) => !value || (Number(value) >= 1.0 && Number(value) <= 5.0),
  ...
  },
  {
    ...
    type: "tags",
    defaultValue: [],
    description: "List regulations/standards this project must comply with (e.g., NOM-001, NOM-127, EPA)",
    tags: ["regulation", "standard", "norm", "compliance", "law"],
    suggestedSource: "manual",
    options: [
      // México - Simplified nomenclature (avg 50% shorter)
  ...
  // ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
  {
    ...
    defaultValue: 0,
    typicalRange: { min: 0, max: 100 },
    description: "Total petroleum hydrocarbons - regulatory requirement for oil & gas operations",
  ...
  // ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
  // HEAVY METALS (Individual parameters for better data structure)
  // ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
  {
    id: "cadmium",
    label: "Cadmium (Cd)",
    ...
    description: "Cadmium concentration - highly toxic heavy metal, strictly regulated",
  ...
  },
  {
    ...
    description: "Lead concentration - toxic heavy metal, common in industrial wastewater",
  ...
  },
  {
    ...
    description: "Mercury concentration - extremely toxic, bioaccumulative heavy metal",
