	...
	sections: [
		{
			...
			fieldOverrides: {
				...
				tds: {
					...
					required: true,
					description:
						"SDT - Sólidos Disueltos Totales, muy alto en agua producida (brine)",
				},
				tss: {
					importance: "critical",
					required: true,
				...
				tph: {
					...
					required: true,
					description:
						"Hidrocarburos Totales de Petróleo - requerimiento regulatorio",
				},
				cadmium: {
					importance: "critical",
					required: false,
					description:
						"Cadmio - metal pesado altamente tóxico, estrictamente regulado",
				},
				chromium: {
					importance: "critical",
					required: false,
				...
				lead: {
					...
					required: false,
					description:
						"Plomo - metal pesado tóxico, común en aguas industriales",
				},
				mercury: {
					importance: "critical",
					required: false,
		...
		},
		{
			...
			fieldOverrides: {
				"regulatory-requirements": {
					...
					required: true,
					placeholder:
						"Oil & gas requiere permisos de descarga (EPA, SEMARNAT, NOM-001, etc.)",
				},
				constraints: {
					importance: "critical",
					description:
						"Restricciones comunes: sensibilidad ambiental, ubicación remota, alto TDS",
				},
			},
		},
	],
